...
class Data
{
    public:
        ...
        static QString getFountainName(QString listName, int id);

        static QQueue<MusicFountainInfo> getMusicList(QString listName);
        static void addMusicsToEnd(QString listName, QQueue<MusicFountainInfo> musics);
        ...
        static int getLastListIndex();
        static void changeLastListIndex(int index);
        static int getPassword();
        static void changePassword(int index);
