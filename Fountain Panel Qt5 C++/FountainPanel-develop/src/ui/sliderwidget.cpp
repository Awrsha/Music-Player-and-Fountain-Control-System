...
void SliderWidget::paintEvent(QPaintEvent *)
{
    ...
    QPen pen;
    pen.setColor(/*QColor(122, 139, 152)*/ProjectTheme::Colors::PRIMARY_COLOR_LIGHT);
    pen.setWidth(0.5);
    painter.setPen(pen);
    painter.setBrush(/*QColor(122, 139, 152)*/ProjectTheme::Colors::PRIMARY_COLOR_LIGHT);
    painter.drawRect(0, 0, this->width()-1, this->height()-1);

    pen.setColor(/*QColor(255, 220, 26)*/ProjectTheme::Colors::ACCENT_COLD_NORMAL);
    painter.setPen(pen);
    painter.setBrush(/*QColor(255, 220, 26)*/ProjectTheme::Colors::ACCENT_COLD_NORMAL);
