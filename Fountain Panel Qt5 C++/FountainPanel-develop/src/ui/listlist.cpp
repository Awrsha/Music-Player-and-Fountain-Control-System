...
//            );
    ...
    QAction *addList = new QAction("Create a list", listMenu);
    QAction *rename = new QAction("Rename", listMenu);
    QAction *deleteList = new QAction("Delete", listMenu);
...
void ListList::setHighLight(int row)
{
    ...
    for (int i = 0; i < columnCount; ++i)
    {
        ...
        item->setBackground(/*QBrush(QColor(128, 150, 244)*/ProjectTheme::Colors::ACCENT_COLD_NORMAL);
    }
}
...
void ListList::removeHighLight(int row)
{
    ...
    for (int i = 0; i < columnCount; ++i)
    {
        ...
        item->setTextColor(/*QColor(0, 0, 0)*/ProjectTheme::Colors::SECONDARY_TEXT_DARK);
        item->setBackground(/*QBrush(QColor(0, 0, 0, 0))*/ProjectTheme::Colors::PRIMARY_COLOR_DARK);
    }
}
