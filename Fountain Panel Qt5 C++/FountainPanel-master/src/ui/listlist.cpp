...
void ListList::setHighLight(int row)
{
    ...
    for (int i = 0; i < columnCount; ++i)
    {
        ...
        item->setBackground(/*QBrush(QColor(128, 150, 244)*/ProjectTheme::Colors::ACCENT_COLD);
    }
}
...
void ListList::removeHighLight(int row)
{
    ...
    for (int i = 0; i < columnCount; ++i)
    {
        ...
        item->setTextColor(/*QColor(0, 0, 0)*/ProjectTheme::Colors::SECONDARY_TEXT);
        item->setBackground(/*QBrush(QColor(0, 0, 0, 0))*/ProjectTheme::Colors::PRIMARY_DARK);
    }
}
