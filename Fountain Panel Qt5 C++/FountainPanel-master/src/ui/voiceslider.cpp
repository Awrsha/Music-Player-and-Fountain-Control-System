...
void VoiceSlider::paintEvent(QPaintEvent *)
{
    ...
    QPen pen;
    painter.setBrush(/*QColor(122, 139, 152)*/ProjectTheme::Colors::PRIMARY_LIGHT);
    painter.drawRect(0, 0, this->width()-1, this->height()-1);

    pen.setColor(/*QColor(122, 139, 152)*/ProjectTheme::Colors::PRIMARY_LIGHT);
    pen.setWidth(0.5);
    painter.setPen(pen);
    painter.setBrush(/*QColor(122, 139, 152)*/ProjectTheme::Colors::PRIMARY_LIGHT);
    painter.drawRect(0, 0, this->width()-1, this->height()-1);

    pen.setColor(/*QColor(255, 220, 26)*/ProjectTheme::Colors::ACCENT_COLD);
    painter.setPen(pen);
    painter.setBrush(/*QColor(255, 220, 26)*/ProjectTheme::Colors::ACCENT_COLD);
